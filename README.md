...
# `Семинар №5 ДЗ. Знакомство с "Python"`
...
# `Семинар №6 ДЗ. Знакомство с "Python"`

* **`Задача № 25.`** Задача: предложить улучшения кода для уже решённых задач:

С помощью использования **лямбд, filter, map, zip, enumerate, list comprehension

# `Семинар №7 ДЗ. Знакомство с "Python"`

* **`Задача № 26.`** Задание в группах: Создать телефонный справочник с возможностью импорта и экспорта данных в нескольких форматах.